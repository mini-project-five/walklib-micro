...
export const UserTypeSelector = ({ onSelectType, onApiTest, onIntegrationTest }: UserTypeSelectorProps) => {
            ...
            {onApiTest && (
              <div>
                <Button 
                  onClick={onApiTest}
                  variant="outline"
                  className="bg-gray-100 hover:bg-gray-200 text-gray-700 border-gray-300 mr-3"
                >
                  백엔드 API 연동 테스트
                </Button>
              </div>
