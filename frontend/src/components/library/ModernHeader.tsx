        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              <span className="font-medium text-amber-700">{userInfo?.coins || coins}</span>
            </Button>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                ...
                >
                  ...
                  <span className="hidden sm:inline text-gray-700 font-medium">{getUserDisplayName(currentUser)}</span>
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end" className="w-56 bg-white/95 backdrop-blur-sm border-gray-200/50">
                <div className="px-3 py-2">
                  ...
                  <p className="text-xs text-gray-400">{getUserRoleText(currentUser)}</p>
                </div>
                <DropdownMenuSeparator />
